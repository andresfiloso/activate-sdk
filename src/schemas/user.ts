...
const getUserSchema = Joi.object({
  ...
  isDriver: Joi.boolean().valid(true, false).optional(),
});
...
const userSchema = Joi.object({
  ...
  phone: Joi.string().min(1).max(30).allow(null, '').optional(),
  role: Joi.string().valid('ADMIN', 'AV', 'COMPRAS', 'OPERACION').optional(),
